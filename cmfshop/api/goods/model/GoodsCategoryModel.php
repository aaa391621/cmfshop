...
class GoodsCategoryModel extends CommonModel
{
    ...
    {
        $query->alias('goods_category')->where('delete_time', 0)
    ...
    {
        return $this->belongsToMany('GoodsPostModel', 'goods_category_post', 'post_id', 'category_id');
    }
    ...
    {
        return self::hasMany('GoodsCategoryPostModel', 'category_id', 'id');
    }

    /**
     * [categoryPostIds 此类商品id数组]
     * @Author:   wuwu<15093565100@163.com>
