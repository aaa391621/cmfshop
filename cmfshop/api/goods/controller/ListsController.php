...
class ListsController extends RestBaseController
{
    ...
    public function recommended()
    {
        ...
        $articles = $goodsPostModel->getDatas($param);

        $this->success('ok', ['list' => $articles]);
    }

    /**
     * [getCategoryPostLists 分类商品列表]
     * @Author:    wuwu<15093565100@163.com>
    ...
    public function getCategoryPostLists()
    {
        ...
        $findCategory = $goodsCategoryModel->where('id', $categoryId)->find();
        ...
        $articles = $goodsCategoryModel->paramsFilter($param, $findCategory->articles()->alias('post'))->select();
