...
use api\goods\model\GoodsTagModel;

class TagsController extends RestBaseController
{
    protected $tagModel;

    public function __construct(GoodsTagModel $tagModel)
    {
        parent::__construct();
    ...
    public function articles($id)
    {
        if (intval($id) === 0) {
            ...
            $postModel          = new GoodsPostModel();

            $articles = $postModel->setCondition($params)->alias('a')->join('__GOODS_TAG_POST__ tp', 'a.id = tp.post_id')
